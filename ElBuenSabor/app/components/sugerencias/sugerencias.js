...
var isInit = true,
    ...
    service = require('./sugerencias-service'),
    // additional requires

    viewModel = require('./sugerencias-view-model');
...
function onAddItemTap(args) {
    helpers.navigate({
        moduleName: 'components/sugerencias/addItemForm/addItemForm'
    });
}
        ...
        .then(function(result) {
            ...
            result.forEach(function(item) {
                ...
                itemsList.push({
                    ...
                    header: item.sugerencia,

                    description: item.puntuacion,
